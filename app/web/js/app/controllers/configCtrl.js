...
(function () {
  ...
  function configController($scope, $interval, $http, $filter) {
    ...
    function getDashboardTypes(column) {
      ...
      switch (column) {
        case 'address':
          types.push('nicehash', 'bitcoinBalance', 'cryptoidBalance', 'counterpartyBalance', 'ethBalance', 'burstBalance', 'node-cryptonote-pool', 'snipa-nodejs-pool', 'yiimp', 'hdpool', 'hpool', 'burst-wallet', 'boom-wallet');
          break;
        case 'ticker':
        ...
        case 'apiKey':
          ...
          break;
        case 'userId':
          types.push('genericMPOS', 'miningpoolhub', 'nicehashBalance', 'hdpool', 'hpool');
          break;
