    ...
    function getDashboardTypes(column) {
      ...
      switch (column) {
        ...
        case 'baseUrl':
          ...
          break;
        case 'apiKey':
          types.push('genericMPOS', 'miningpoolhub', 'cryptoidBalance', 'nicehashBalance', 'coinbase', 'hdpool', 'bitmart-balance');
          break;
        case 'userId':
          types.push('genericMPOS', 'miningpoolhub', 'nicehashBalance', 'hdpool');
          break;
